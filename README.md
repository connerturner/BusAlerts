### Please See [vuejs-build branch tree](https://github.com/connerturner/BusAlerts/tree/vuejs-build) for the most up to date branch (Issue [#9](https://github.com/connerturner/BusAlerts/issues/9))
